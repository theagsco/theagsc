  ...
  <?php get_template_part('templates/page', 'header'); ?>
	...
	<article>
	    <div class="entry-content">
			...
			<div class="contact-email articlewidth center"><a href="mailto:hello@theagsc.com" class="btn btn-green"><span>hello@theagsc.com</span><img class="svg" src="<?php bloginfo('template_directory'); ?>/assets/images/icons_sub.svg"/></a></div>
	    </div>
	</article>
