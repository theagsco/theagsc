  ...
  <div class="container">
    ...
    <nav class="collapse navbar-collapse" role="navigation">
      <ul>
	    ...
	    <li><a href="<?php bloginfo('home'); ?>/about">Work</a></li>
	    <li><a href="<?php bloginfo('home'); ?>/about">Community</a></li>
	    <li><a href="<?php bloginfo('home'); ?>/about">Shop</a></li>
	    <li><a href="<?php bloginfo('home'); ?>/about">Contact</a></li>
	</ul>
    </nav>
  </div>
